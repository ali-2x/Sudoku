...
public class Sudoku {
    ...
    int[][] arrayTo2D(int[][][] array) {
        ...
        return result;     //2D array returned
    }
    ...
    String filePicking() {
        ...
        //returns the filename picked by user
    ...
    /**
     * Load cells from a file. Each file should contain 9 lines of 9 digits.
